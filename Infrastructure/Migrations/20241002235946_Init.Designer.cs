            ...
            modelBuilder.Entity("Model.Entities.Admin", b =>
                {
                    ...
                    b.HasOne("Model.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Model.Entities.Admin", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Entities.Customers.Customer", b =>
                {
                    ...
                    b.HasOne("Model.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Model.Entities.Customers.Customer", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Entities.Suppliers.Supplier", b =>
                {
                    ...
                    b.HasOne("Model.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Model.Entities.Suppliers.Supplier", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
